...
export default function Renderer({
  ...
  console.log('body_html', body_html)
  ...
  return (
    <>
      ...
      <div className={`row ${styles.contentWrapper} ${rtlClass}`}>
        ...
        <div className={`col-12 col-lg-4 ${styles.tableOfContents} d-none d-lg-block`}>
...
const SocialComp = ({ text, className }) => {
  return (
    <div className={`${className} ${styles.share_content} d-flex justify-content-between flex-column flex-lg-row gap-2 gap-lg-0 my-4`}>
